	...
	while ((buf[entry_num * 32] != 0x00)) {
				...
				&& (buf[entry_num * 32] != 0xE5)) //long filename
		{
			...
			while (longname_blocks > 0) {
				longname[(longname_blocks - 1) * 13 + 0] = buf[entry_num
						* 32 + 1];
				longname[(longname_blocks - 1) * 13 + 1] = buf[entry_num
						* 32 + 3];
				longname[(longname_blocks - 1) * 13 + 2] = buf[entry_num
						* 32 + 5];
				longname[(longname_blocks - 1) * 13 + 3] = buf[entry_num
						* 32 + 7];
				longname[(longname_blocks - 1) * 13 + 4] = buf[entry_num
						* 32 + 9];
				longname[(longname_blocks - 1) * 13 + 5] = buf[entry_num
						* 32 + 14];
				longname[(longname_blocks - 1) * 13 + 6] = buf[entry_num
						* 32 + 16];
				longname[(longname_blocks - 1) * 13 + 7] = buf[entry_num
						* 32 + 18];
				longname[(longname_blocks - 1) * 13 + 8] = buf[entry_num
						* 32 + 20];
				longname[(longname_blocks - 1) * 13 + 9] = buf[entry_num
						* 32 + 22];
				longname[(longname_blocks - 1) * 13 + 10] = buf[entry_num
						* 32 + 24];
				longname[(longname_blocks - 1) * 13 + 11] = buf[entry_num
						* 32 + 28];
				longname[(longname_blocks - 1) * 13 + 12] = buf[entry_num
						* 32 + 30];
